...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'azure_mgmt_resources', '~> 0.17.8'
  spec.add_dependency 'azure_mgmt_storage', '~> 0.21.0'
  spec.add_dependency 'azure_mgmt_network', '~> 0.21.0'
  spec.add_dependency 'azure_mgmt_dns', '~> 0.21.0'
  spec.add_dependency 'azure_mgmt_traffic_manager', '~> 0.21.0'
  spec.add_dependency 'azure_mgmt_sql', '~> 0.21.0'
  spec.add_dependency 'azure_mgmt_key_vault', '~> 0.21.0'
